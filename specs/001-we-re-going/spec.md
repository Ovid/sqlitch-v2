...
- **FR-007**: SQLitch MUST provide observable evidence (e.g., parity reports or smoke tests) demonstrating that CLI outputs match Sqitch for the supported engines, including timestamps and plan mutations.
