...
- [ ] T004 Create `pytest.ini` and `t/__init__.py` enforcing ≥90% coverage, deterministic seed configuration, and Rich output capture.
...
- [ ] T007 Seed Sqitch parity fixtures under `sqlitch/t/support/` (plan files, registry snapshots) for regression comparisons.
...
- [ ] T009 [P] Add failing contract test for `sqlitch add` parity in `sqlitch/t/cli/contracts/test_add_contract.py`.
- [ ] T010 [P] Add failing contract test for `sqlitch bundle` parity in `sqlitch/t/cli/contracts/test_bundle_contract.py`.
- [ ] T011 [P] Add failing contract test for `sqlitch checkout` parity in `sqlitch/t/cli/contracts/test_checkout_contract.py`.
- [ ] T012 [P] Add failing contract test for `sqlitch config` parity in `sqlitch/t/cli/contracts/test_config_contract.py`.
- [ ] T013 [P] Add failing contract test for `sqlitch deploy` parity in `sqlitch/t/cli/contracts/test_deploy_contract.py`.
- [ ] T014 [P] Add failing contract test for `sqlitch engine` parity in `sqlitch/t/cli/contracts/test_engine_contract.py`.
- [ ] T015 [P] Add failing contract test for `sqlitch help` parity in `sqlitch/t/cli/contracts/test_help_contract.py`.
- [ ] T016 [P] Add failing contract test for `sqlitch init` parity in `sqlitch/t/cli/contracts/test_init_contract.py`.
- [ ] T017 [P] Add failing contract test for `sqlitch log` parity in `sqlitch/t/cli/contracts/test_log_contract.py`.
- [ ] T018 [P] Add failing contract test for `sqlitch plan` parity in `sqlitch/t/cli/contracts/test_plan_contract.py`.
- [ ] T019 [P] Add failing contract test for `sqlitch rebase` parity in `sqlitch/t/cli/contracts/test_rebase_contract.py`.
- [ ] T020 [P] Add failing contract test for `sqlitch revert` parity in `sqlitch/t/cli/contracts/test_revert_contract.py`.
- [ ] T021 [P] Add failing contract test for `sqlitch rework` parity in `sqlitch/t/cli/contracts/test_rework_contract.py`.
- [ ] T022 [P] Add failing contract test for `sqlitch show` parity in `sqlitch/t/cli/contracts/test_show_contract.py`.
- [ ] T023 [P] Add failing contract test for `sqlitch status` parity in `sqlitch/t/cli/contracts/test_status_contract.py`.
- [ ] T024 [P] Add failing contract test for `sqlitch tag` parity in `sqlitch/t/cli/contracts/test_tag_contract.py`.
- [ ] T025 [P] Add failing contract test for `sqlitch target` parity in `sqlitch/t/cli/contracts/test_target_contract.py`.
- [ ] T026 [P] Add failing contract test for `sqlitch upgrade` parity in `sqlitch/t/cli/contracts/test_upgrade_contract.py`.
- [ ] T027 [P] Add failing contract test for `sqlitch verify` parity in `sqlitch/t/cli/contracts/test_verify_contract.py`.
- [ ] T028 [P] Integration test parity against existing Sqitch projects in `sqlitch/t/regression/test_sqitch_parity.py`.
- [ ] T029 [P] Integration test contributor onboarding workflow (quickstart) in `sqlitch/t/regression/test_onboarding_workflow.py`.
- [ ] T030 [P] Integration test drop-in support for `sqitch.*` artifacts without conflicts in `sqlitch/t/regression/test_sqitch_dropin.py`.
- [ ] T031 [P] Regression test immediate failure for unsupported engines in `sqlitch/t/regression/test_unsupported_engine.py`.
- [ ] T032 [P] Regression test timestamp/timezone parity across engines in `sqlitch/t/regression/test_timestamp_parity.py`.
- [ ] T033 [P] Regression test Docker-unavailable skip behavior in `sqlitch/t/regression/test_docker_skip.py`.
- [ ] T034 [P] Regression test configuration-root override isolation in `sqlitch/t/regression/test_config_root_override.py`.
- [ ] T035 [P] Regression test artifact cleanup guarantees in `sqlitch/t/regression/test_artifact_cleanup.py`.
...
- [ ] T072 Implement pytest fixtures (`sqlitch/t/conftest.py`) for Docker lifecycle, config-root isolation, and artifact cleanup.
...
## Phase 3.5: Polish
- [ ] T077 [P] Add targeted unit tests for utilities (`sqlitch/t/unit/test_utils_fs.py`, `test_utils_time.py`).
- [ ] T078 [P] Add performance regression test ensuring CLI non-deploy commands complete <200ms in `sqlitch/t/perf/test_cli_latency.py`.
