...
- Default CLI output MUST mirror Sqitch’s human-readable lines (e.g., `Deploying changes to …` / `+ change .. ok`) without emitting structured log metadata unless the user explicitly opts into verbose or JSON modes.
