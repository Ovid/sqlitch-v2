...
def test_isolated_test_context_helper_is_available():
    ...
    import inspect
    assert hasattr(isolated_test_context, "__call__"), (
        "isolated_test_context should be callable"
    )
...
def test_readme_documents_isolation_requirements():
    ...
    assert readme_path.exists(), (
        "tests/support/README.md must exist to document isolation patterns"
    )
    ...
    assert not missing, (
        f"README.md missing required documentation for: {missing}"
    )
